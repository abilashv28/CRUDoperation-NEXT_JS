    ...
    >
      ...
      <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          <DialogPanel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg w-full max-w-[90%]">
            <form onSubmit={formik.handleSubmit}>
              <div className="bg-white px-4 pb-2 pt-2 sm:p-6 sm:pb-4">
                ...
                <div className="bg-gray-50 px-2 py-3 mt-5 flex flex-col sm:flex-row gap-5">
                  <button
                    type="submit"
